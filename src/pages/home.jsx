        ...
        <Container maxWidth="lg" className={classes.root}>
            <Grid container spacing={5} className={classes.mainGrid}>
                <Grid item xs={12} md={8}>
                    ...
                    <Divider />
                    <Typography className={classes.paragraph} paragraph>
                        ООО «ЯрАналитПрибор» является в Ярославской области представителем заводов-изготовителей приборов учета тепловой энергии: АО НПФ «Логика», АО «Взлет», ГПК «ЭМИС», ООО «Теплотрон». Также мы давно и тесно сотрудничаем с другими ведущими предприятиями данной отрасли – ООО «Термотроник», ГК «Теплоком», ООО «ТБН Энергосервис» и другими.
                ...
                <Grid item xs={12} md={4}>
                    ...
                    <img
                        src={vzlet}
                        alt="Установка теплосчетчиков в Ярославле"
                        title="Установка теплосчетчиков в Ярославле"
